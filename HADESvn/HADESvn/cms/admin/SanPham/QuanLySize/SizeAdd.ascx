<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SizeAdd.ascx.cs" Inherits="HADESvn.cms.admin.SanPham.QuanLySize.SizeAdd" %>
...
<div class="row g-3 from-margin-lr">
     <div class="col-md-12 col-btn-add">
        <a href="AdminPage.aspx?modul=SanPham&modulphu=Size&thaotac=HienThi" class="btn btn-not btn-add"><ion-icon name="apps-outline"></ion-icon>Xem Size</a>
    </div>
    <div class="col-md-3">
        <label for="inputPassword4" class="form-label">Tên Size</label>
        <asp:TextBox ID="txtSize" runat="server" CssClass="form-control"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtSize" Display="Dynamic" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
    </div>
    <div class="col-12">
