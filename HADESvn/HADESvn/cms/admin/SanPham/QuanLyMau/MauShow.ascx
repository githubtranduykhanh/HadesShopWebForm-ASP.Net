<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MauShow.ascx.cs" Inherits="HADESvn.cms.admin.SanPham.QuanLyMau.MauShow" %>
...
<div class="row g-3 from-margin-lr">
    <div class="col-md-12 col-btn-add">
        <a href="AdminPage.aspx?modul=SanPham&modulphu=Mau&thaotac=ThemMoi" class="btn btn-not btn-add">
    ...
    function XoaMau(MauID) {
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.post("SanPham/QuanLyMau/Ajax/Mau",
                    {
                        "ThaoTac": "XoaMau",
                        "MauID": MauID
                    },
