<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietDonHang.aspx.cs" Inherits="HADESvn.cms.admin.SanPham.QuanLySanPham.ChiTietDonHang" %>
...
<head runat="server">
    <title></title>
    <link href="../../../../assets/css/cssChiTietDonHang.css" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="thongTinKH">
            ...
            <ul style="list-style:none;padding-left:0px; margin-left:0px;">
                ...
                <li>Đại Chỉ: <asp:Literal ID="ltrDiaChiKH" runat="server"></asp:Literal></li>
            </ul>
        </div>
        ...
        <div class="thongTinCuoi">
            ...
            Cửa hàng local brand Hades<br/>
            Địa chỉ: 147 Bùi Đình Tuý, Phường 24, Bình Thạnh, Thành phố Hồ Chí Minh<br/>
            Số điện thoại: 0902 234 481<br/>
            Email: hades@gmail.com<br/>
