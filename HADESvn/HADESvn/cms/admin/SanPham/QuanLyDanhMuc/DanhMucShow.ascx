<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMucShow.ascx.cs" Inherits="HADESvn.cms.admin.SanPham.QuanLyDanhMuc.DanhMucShow" %>
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link" href="AdminPage.aspx?modul=SanPham&modulphu=DanhSachSanPham&thaotac=HienThi">Quản Lý Sản Phẩm</a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="AdminPage.aspx?modul=SanPham&modulphu=DanhMuc&thaotac=HienThi">Quản lý Danh Mục</a>
    </li>
    <li class="nav-item">
...
<div class="row g-3 from-margin-lr">
    <div class="col-md-12 col-btn-add">
        <a href="AdminPage.aspx?modul=SanPham&modulphu=DanhMuc&thaotac=ThemMoi" class="btn btn-not btn-add"><ion-icon name="add-circle-outline"></ion-icon>Thêm Danh Mục</a>
    </div>
    <div class="col-12">
...
<!--Modal Search-->
        <div class="modal modal-search js-xem-dm">
            <div class="modal-close js-xem-dm-close" onclick="CloseModal()">
...
<script type="text/javascript">
    function XoaDanhMuc(MaDM)
    {
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.post("SanPham/QuanLyDanhMuc/Ajax/DanhMuc",
    ...
    function DanhMuc(MaDM)
    {
            ...
            $.post("SanPham/QuanLyDanhMuc/Ajax/XemDanhMuc",
                {
                    "ThaoTac": "DanhMuc",
                    "MaDM": MaDM
                },
                function (data, status) {
                    $(".js-xem-dm").addClass("open");
                    /* alert("Data :" + data + "\n Status :" + status);*/                 
                    $(".xemdm").html(data);
                });
