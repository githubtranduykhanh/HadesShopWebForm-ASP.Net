...
namespace HADESvn.cms.index.page
{
    public partial class ThanhToanTrucTuyen : System.Web.UI.Page
    {
        ...
        public static long TongTienInt;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string dataTimeNow = DateTime.Now.ToString("dd/MM/yyyy hh:mm:ss tt");
                txtOrderDesc.Text = Request.QueryString["hoTentt"] + " thanh toán hóa đơn " + dataTimeNow;
                txtExpire.Text = DateTime.Now.AddMinutes(15).ToString("yyyyMMddHHmmss");
                //Response.Write(Request.Params["hoTen"] + Request.Params["diaChi"] + Request.Params["soDienThoai"] + Request.Params["email"]);
            }

            TongTienInt = Convert.ToInt64(Request.QueryString["tongTien"]);
            txtTongTien.Text = string.Format("{0:0,000}", TongTienInt) + " VNĐ";
            //hoTen = Request.Params["hoTen"];
            //diaChi = Request.Params["diaChi"];
            //soDienThoai = Request.Params["soDienThoai"];
            //email = Request.Params["email"];
            txt_billing_fullname.Text = Request.QueryString["hoTentt"];
            txt_billing_addr1.Text = Request.QueryString["diaChitt"];
            txt_billing_mobile.Text = Request.QueryString["soDienThoaitt"];
            txt_billing_email.Text = Request.QueryString["emailtt"];
        ...
        {
            long TongTien64;
            TongTien64 = Convert.ToInt64(Request.QueryString["tongTien"]);
            //Get Config Info
            ...
            order.Amount = TongTien64; // Giả lập số tiền thanh toán hệ thống merchant gửi sang VNPAY 100,000 VND
            ...
            vnpay.AddRequestData("vnp_Bill_Address", txt_billing_addr1.Text.Trim());
